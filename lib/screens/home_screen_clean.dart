...
class HomeScreen extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (provider.settings.studentId.isEmpty) ...[
  ...
  Widget _buildQuickViewStats(AttendanceProvider provider) {
    final threshold = provider.settings.attendanceThreshold;
    final percentage = provider.overallAttendancePercentage;
    final totalClasses = provider.subjects.fold<int>(0, (sum, s) => sum + s.totalClasses);
    final attendedClasses = provider.subjects.fold<int>(0, (sum, s) => sum + s.attendedClasses);
